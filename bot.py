...
def chatbot_response(user_input):
    ...
    if "hello" in user_input or "hi" in user_input:
        ...
        return "My name is Vision and I am a rule-based chatbot."
    elif "how are you?" in user_input:
        return "I'm just a program, but I'm here to help you!"
    elif "name" in user_input:
        return "My name is Vision."
    elif "who invented you?" in user_input:
        return "I was invented by Mr.Koteswara Rao."
        ...
        return "I was created by Mr. Koteswara rao."
